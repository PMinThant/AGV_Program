...
static PyObject* pyopencv_cv_dnn_blobFromImage(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "image", "scalefactor", "size", "mean", "swapRB", "crop", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|dOObb:blobFromImage", (char**)keywords, &pyobj_image, &scalefactor, &pyobj_size, &pyobj_mean, &swapRB, &crop) &&
        pyopencv_to(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 0)) )
    {
        ERRWRAP2(retval = cv::dnn::blobFromImage(image, scalefactor, size, mean, swapRB, crop));
        return pyopencv_from(retval);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_dnn_blobFromImages(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "images", "scalefactor", "size", "mean", "swapRB", "crop", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|dOObb:blobFromImages", (char**)keywords, &pyobj_images, &scalefactor, &pyobj_size, &pyobj_mean, &swapRB, &crop) &&
        pyopencv_to(pyobj_images, images, ArgInfo("images", 0)) &&
        pyopencv_to(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to(pyobj_mean, mean, ArgInfo("mean", 0)) )
    {
        ERRWRAP2(retval = cv::dnn::blobFromImages(images, scalefactor, size, mean, swapRB, crop));
        return pyopencv_from(retval);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_text_TextDetectorCNN_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::text;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO:TextDetectorCNN_create", (char**)keywords, &pyobj_modelArchFilename, &pyobj_modelWeightsFilename) &&
