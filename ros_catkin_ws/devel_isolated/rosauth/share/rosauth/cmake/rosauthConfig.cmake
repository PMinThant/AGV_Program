...
if("TRUE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/rosauth)
  set(rosauth_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/rosauth)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "/home/pi/ros_catkin_ws/devel_isolated/rosauth/include " STREQUAL " ")
  set(rosauth_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/devel_isolated/rosauth/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/rosauth/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/rosauth/lib;/opt/ros/kinetic/lib)
