...
if("TRUE" STREQUAL "TRUE")
  set(opencv_tests_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/cv_bridge/opencv_tests)
  set(opencv_tests_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/opencv_tests)
  ...
  set(opencv_tests_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/cv_bridge/opencv_tests/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/opencv_tests/lib;/opt/ros/kinetic/lib)
